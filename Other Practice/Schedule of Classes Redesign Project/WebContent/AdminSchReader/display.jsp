...
<p align="left">
	 ...
	 <a href="logout.jsp"><font size="5">Log out</font></a></body> </b>&nbsp;<br>
...
<%
   ...
   try
   {
       ...
       */
       ...
       String Query2 = "update SEMESTER_SCHEDULE_READER set START_DATE = TO_CHAR(?,'MM/DD/YYYY'), END_DATE = TO_CHAR(?,'MM/DD/YYYY') where SEMESTER_NAME = ?";
