...
public class userLogin {
    ...
    public static void main(String[] args){
        JFrame frame = new JFrame("Motor City Repair");
        ...
        mary.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e){
                ...
                JOptionPane.showMessageDialog(null, "You must enter a valid User Name & Password.");
                //usertf.setText("");
                //passwordtf.setText("");
                }else{
                JOptionPane.showMessageDialog(null, "You are logged in to Mary's Garage.");
                System.exit(1);
                }
                }
